    ...
    <header className="sticky top-0 z-30 border-b border-slate-200 bg-white/90 px-4 py-3 backdrop-blur-2xl dark:border-white/10 dark:bg-[#071922]/90 lg:px-6">
      <div className="flex flex-col gap-3 xl:flex-row xl:items-center">
        <div className="flex min-w-0 items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-[-0.04em] text-slate-950 dark:text-white">{pageTitle}</h1>
        ...
        <div className="flex flex-1 flex-wrap items-center gap-2 xl:justify-end">
          ...
          <button className="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm font-semibold text-slate-700 shadow-sm dark:border-white/10 dark:bg-white/5 dark:text-white">
            <FiCalendar className="text-emerald-600" /> {today}
          </button>
          ...
          <button onClick={handleAddWidget} disabled={extraWidgetCount >= dashboardWidgetPool.length} className="inline-flex items-center gap-2 rounded-xl bg-emerald-600 px-4 py-3 text-sm font-bold text-white shadow-lg shadow-emerald-600/20 disabled:cursor-not-allowed disabled:opacity-50"><FiPlus /> Widget Ekle</button>
